            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                ...
                <div className='flex items-center gap-8'>
                    <motion.ul initial={{ opacity: 0, x: 200 }}
                        animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 200 }}
                        className='flex items-center gap-8'>
                        <li className='text-base text-textColor hover:text-headingColor
                    diuration-100 transition-all ease-in-out cursor-pointer'>
                            Home
                        </li>
                        <li className='text-base text-textColor hover:text-headingColor
                    diuration-100 transition-all ease-in-out cursor-pointer'>
                    ...
                    />
                    {
                        isMenu && (
                            <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.6 }}
                                ...
                                <p className='m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer bg-gray-200 justify-center
