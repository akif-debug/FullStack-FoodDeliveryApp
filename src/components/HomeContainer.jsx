    ...
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
            <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Nulla quasi quibusdam sint exercitationem assumenda, perferendis illum consequuntur quis
                    rerum reiciendis dicta minima vero adipisci nihil eius provident nemo dolore velit</p>
            ...
            <div className="py-2 flex-1 flex items-center relative">
                ...
                <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap">
                    {heroData && heroData.map(n => (
                        <div key={n.id} className=" lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col 
                        items-center justify-center drop-shadow-lg">
                            <img src={n.imageSrc} className='lg:w-40 w-20 -mt-10 lg:-mt-20' />
